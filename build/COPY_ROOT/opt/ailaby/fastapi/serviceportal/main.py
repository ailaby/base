...
base_dir = "/opt/ailaby/fastapi/serviceportal/"
...
async def post(request: Request):
    ...
    if user == os.environ.get('WEB_USER') and password == os.environ.get('WEB_PASSWORD'):
        response.set_cookie(key="ailaby_token", 
...
def get_index_context(request, message=None):
    ...
    return {
        ...
        "request": request,
        "page": "index",
        "auth_token": request.cookies.get("ailaby_token"),
        "services": services,
...
@app.websocket("/ailaby/logtail.sh")
